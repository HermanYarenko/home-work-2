public class task2 {
    ...
    public static void main(String[]args) {
        String jsonString ="[{\"фамилия\":\"Иванов"\,\"оценка"\:\"5"\,\"Математика\"}," +
            "{\"фамилия\":\"Петрова"\,\"оценка"\:\"4"\,\"Информатика\"}," +
            "{\"фамилия\":\"Краснов"\,\"оценка"\:\"5"\,\"Физика\"}]";
        parseAndPrintJson(jsonString);

    }
    private static void parseAndPrintJson(String jsonString) {
